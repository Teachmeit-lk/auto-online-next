...
interface IConfirmQuotationConfirmationModalProps {
  isOpen: boolean;
  onConfirm: () => void;
  onClose: () => void;
}

export const ConfirmQuotationConfirmationModal: React.FC<
  IConfirmQuotationConfirmationModalProps
          ...
          <div className="bg-[#F8F8F8] rounded-[5px] ml-4 mr-4 mt-2  p-4 flex flex-col items-center justify-center">
            <div className="">
              <p className="text-[11px] text-[#111102] font-body font-[500] text-center">
                Are you sure to confirm this estimate now?
              </p>
            </div>
