...
const initialProducts = [
  ...
  {
    type: "Electricals",
    description: "Servicess from $71.50 now",
    price: "$71.50",
    image: OService2,
    rating: 4.8,
  },
        ...
        <div className="flex space-x-6">
          {products.map((product, index) => (
            ...
            >
              ...
              <button className="bg-yellow-400 text-[#111102] text-[8px] font-body font-bold rounded-[5px]   mt-3 hover:bg-yellow-500 w-[50px] h-[18px]">
                Shop Now
              </button>
            </div>
          ))}
