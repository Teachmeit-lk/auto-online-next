...
const AdminFuelTypesPage: React.FC = () => {
  ...
  const load = async () => {
    setLoading(true);
    try {
      const list = await FirestoreService.getAll<FuelTypeDoc>(
  ...
  const onSubmit = async (data: CreateTypeForm) => {
    ...
    setError(null);
    try {
      await FirestoreService.create<FuelTypeDoc>(COLLECTIONS.FUEL_TYPES, {
        name: data.name,
        isActive: true,
      } as any);
  ...
  const onEditSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setError(null);
    try {
      await FirestoreService.update<FuelTypeDoc>(
        COLLECTIONS.FUEL_TYPES,
        selected.id,
